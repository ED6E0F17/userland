...
SET(CMAKE_C_COMPILER ${ANDROID_TOOLCHAIN}/aarch64-linux-android-gcc)
SET(CMAKE_CXX_COMPILER ${ANDROID_TOOLCHAIN}/aarch64-linux-android-g++)
SET(CMAKE_ASM_COMPILER ${ANDROID_TOOLCHAIN}/aarch64-linux-android-gcc)
...
SET(CMAKE_C_FLAGS  "${CMAKE_C_FLAGS} -I${ANDROID_ROOT}/bionic/libc/kernel/uapi/asm-arm64/")
